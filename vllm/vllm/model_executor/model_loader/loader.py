...
def _apply_streaming_modifications(model: nn.Module, vllm_config: VllmConfig) -> None:
    """Apply streaming modifications to the model if enabled."""
    ...
    try:
        ...
        # Don't raise the exception to avoid breaking model loading
        # The model will work without streaming functionality
...
def _initialize_model(
    ...
    *,
    ...
    if "vllm_config" in all_params and "prefix" in all_params:
        ...
        # Apply streaming modifications if enabled
