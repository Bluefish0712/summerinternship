...
async def main():
    ...
    conversation_id = "my-infinite-conversation-chinese"
    ...
    print(f"\n=== 测试结束 ===")
    print(f"成功完成了 {i+1} 轮中文对话。")
    print(f"StreamingLLM 成功处理了大量的中文对话内容，展示了其在长对话场景下的稳定性。")
